...
export const useToast = () => {
  ...
  const createToast = (
    ...
    const styles = {
      ...
      warning: "bg-background-950 border-ambar-500/50 text-ambar-400",
    ...
    const icons = {
      ...
      error: <i className={`pi pi-exclamation-triangle`} />,
      warning: <i className={`pi pi-exclamation-circle `} />,
  ...
  return {
    ...
    message: (msg: string, opts?: CustomToastOptions) => createToast("message", msg, opts),
    warning: (msg: string, opts?: CustomToastOptions) => createToast("warning", msg, opts),
