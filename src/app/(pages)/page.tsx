...
export default async function Home() {
  return (
    <section
      className={`flex flex-col gap-8 w-full h-full overflow-y-auto overflow-x-hidden md:pt-8 md:bg-background md:transition-[heigth] md:duration-200 lg:pt-24 lg:pl-18`}
    >
      ...
      <Carousel title="Playlists populares" options={{ type: ["playlists"] }} />
    </section>
  );
}
