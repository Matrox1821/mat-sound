  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      <g fill="none">
        ...
        ></path>
        <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="m22 8l-10 4"></path>
        <path
          fill="currentColor"
        ...
        <path
          ...
          strokeWidth={1.5}
          d="M7 11V2c0 2.071 1.757 3 3 3m-3 5.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0"
          opacity={0.5}
        ></path>
      </g>
    </svg>
