  ...
  return (
    <div className="w-full flex flex-col">
      <label className="grid grid-cols-12 relative w-full z-10">
        ...
        />
        <input
          className="col-start-1 col-end-12 input-value bg-background border-2 border-[rgb(176,178,186)] border-r-0 h-8 focus-visible:border-accent/90 focus:border-2 
          rounded-l-md
        ...
        <div className="border-2 border-[rgb(176,178,186)] rounded-b-md pt-2 -translate-y-3 z-0 ">
          {elements.map((elementName, i) => (
            <div
              ...
              key={elementName + i}
            >
              <span className="!border-x-4 !border-x-transparent col-start-1 col-end-12 flex items-center w-auto border-r-0 border-[rgb(176,178,186)] rounded-md rounded-e-none h-8 focus-visible:border-accent/90 focus:border-2 outline-none py-4 pl-1 gap-2 overflow-hidden text-ellipsis">
                {elementName}
              </span>
              <button
