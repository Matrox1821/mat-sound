...
const ContentHidden = () => (
  <>
    <path d="m5.24 22.51l1.43-1.42A14.06 14.06 0 0 1 3.07 16C5.1 10.93 10.7 7 16 7a12.4 12.4 0 0 1 4 .72l1.55-1.56A14.7 14.7 0 0 0 16 5A16.69 16.69 0 0 0 1.06 15.66a1 1 0 0 0 0 .68a16 16 0 0 0 4.18 6.17" />
...
export function PasswordVisibility({ isHidden, ...props }: HeartProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={32} height={22} viewBox="0 0 34 22" {...props}>
      {isHidden ? <ContentHidden /> : <ContentShow />}
    </svg>
  );
}
